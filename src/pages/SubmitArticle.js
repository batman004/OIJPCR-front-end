...
const SubmitArticle = () => (<div className="flex-grow max-w-7xl">
    <div className="flex items-center justify-center my-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl">Guidelines
            for submissions</h1>
    </div>
    <div className="mx-4 my-2 max-w-5xl">
        <ol className="list-decimal py-2 px-4 md:px-8">
            {guidelinesList.map((guideline, index) => {
                return (<li key={index} className="py-2 font-medium font-sans">{guideline}</li>);
            })}
        </ol>
    </div>
